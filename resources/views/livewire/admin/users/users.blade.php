    ...
    <div class="container">
        <div class="card shadow-sm">
            <div class="card-header">
                <h3 class="card-title">تمام والدین</h3>
                <div class="card-toolbar">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="row">
                            ...
                            <div class="col-auto">
                                <button type="button" class="btn btn-primary" wire:click.prevent="new()"> والدین جدید </button>
                            </div>
                        </div>
                    </div>
                    ...
                    <table class="table table-striped gy-7 gs-7">
                        <thead>
                            <tr class="fw-semibold fs-6 text-gray-800 border-bottom-2 border-gray-200">
                                <th class="min-w-200px">نام و نام خوانوادگی</th>
                                <th class="min-w-400px">تعداد فرزند</th>
                                <th class="min-w-100px">تلفن همراه</th>
                                <th class="min-w-200px">سن</th>
                                <th class="min-w-200px"> سهم </th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="" class="text-dark" wire:click.prevent="children()">
