    ...
    <div class="container">
        <div class="card shadow-sm">
            <div class="card-header">
                <h3 class="card-title">تمام دسته بندی ها</h3>
                ...
                <div class="card-toolbar">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="row">
                            ...
                            <div class="col-auto">
                                <button type="button" class="btn btn-primary" wire:click.prevent="new()"> دسته بندی جدید </button>
                            </div>
                        </div>
                    </div>
                ...
                <div class="table-responsive">
                    <table class="table table-striped gy-7 gs-7">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{ $category->attribute()->first()->name }}</td>
