...
return [
    ...
    */
    'attributes' => [
        ...
        "password" => "کلمه عبور",
        "phone" => "شماره تلفن",
        "name_mother" => "نام مادر",
        "email_mother" => "نشان انترنتی",
        "unique_id_mother" => "شناسه اختصاصی",
        "passport_code_mother" => "کد فراگیر گذرنامه",
        "date_birth_mother" => "تاریخ تولد",
        "place_birth_mother" => "محل تولد",
        "literacy_rate_mother" => "میزان سواد",
        "health_mother" => "سلامتی",
        "sahm_mother" => "سهم",
        "skills_mother" => "مهارت های فرهنگی هنری",
        "employment_status_mother" => "وضعیت اشتغال",
        "type_employment_mother" => "نوع اشتغال",
        "job_mother" => "شغل",
        "cause_unemployment_mother" => "علت بیکاری",
        "description_mother" => "توضیحات",
        "avatar_mother" => "عکس",
        "status_mother" => "تاهل",
        "" => "",
        "" => "",
